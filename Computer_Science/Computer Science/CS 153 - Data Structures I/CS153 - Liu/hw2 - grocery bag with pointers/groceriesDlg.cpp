...
// Pre: The button must be clicked.
...
// Pre: The Remove One button must be clicked.
...
// Pre: The Remove All button must be clicked.
...
// Pre: Clear Contents button must be clicked.
