...
Description:   CS 53 - Homework Assignment #7

               Program to test a Set class containing functions that determine
			   if an element is in the set, add or delete an element to/from
			   the set, determine if a set is empty, take the union of two 
			   sets, take the intersection of two sets, and print the contents
			   of a set.
